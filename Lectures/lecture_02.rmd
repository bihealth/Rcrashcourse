 ...
 * How do you change all NA values to zero?
...
Much like vectors, matrices (and arrays, which are multidimensional
matrices) can only hold one data type (e.g. only numeric
