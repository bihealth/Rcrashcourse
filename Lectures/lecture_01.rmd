...
![](images/team_112021.png){ height=400px }
 ...
 * I try to avoid teaching you *programming in R* as such, it is more data
   science with R. However, some programming concepts are unavoidable.
 ...
 * Github: `https://github.com/bihealth/Rcrashcourse`
 * Teams

To view the lectures, click on the link.
 ...
 * Please fill out the survey: [https://forms.gle/roMmixnZHsmbi47x7](https://forms.gle/roMmixnZHsmbi47x7)
 * Please introduce yourself


## A few rules 

 * Ask questions! (don't ask if you may ask questions...)
 * Interrupt me!
 * If you are confused, say so immediately!
 * The slides are to structure our day, but use the book as reference

# How to start

## Example R session

`https://youtu.be/zWt8BC1UNiQ`
...
## Exercise 0: Create a new project

Now create a new project in Rstudio. 

 * Go to File -> New Project
 * Select New Directory -> New Project
 * Give the project a name (e.g. "RcrashCourse")
 * Click on "Create Project"

## Projects

 A project is basically a folder which contains a few special files in
...
## Exercise 1.0: Basic calculations
 ...
 * You should almost never use the console
 * Instead, create R scripts (File -> New File -> R Script)
 * Do that now!
...
slightly different behavior. Sometimes factors behave like numbers.
 ...
 * `https://youtu.be/rnGADz4cuBA` (Functions, 6 minutes)
 * `https://youtu.be/NTnLZQwKhvA` (defining functions, 7 minutes)

## Exercise 1.4 More on vectors (and functions)
 ...
 * plot x vs y (use the simple `plot()` function; how do you run it?)
