...
```{r}
library(qrcode)
plot(qr_code("https://github.com/bihealth/Rcrashcourse/"))
```


Course repository: https://github.com/bihealth/Rcrashcourse

To view the lectures, download the HTML file and open it in a browser, or
click on the link.
...
```{r}
library(qrcode)
plot(qr_code("https://bihealth.github.io/RCrashcourse-book/"))
```


Course book: https://bihealth.github.io/RCrashcourse-book/
